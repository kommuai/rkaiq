...
option(RKAIQ_CAMERA_ONLY "Build the in-process real-camera profile" OFF)
...
elseif (RKAIQ_TARGET_SOC STREQUAL "rk3588")
    ...
    if (NOT RKAIQ_CAMERA_ONLY)
        ...
        set(RKAIQ_HAVE_THUMBNAILS    FALSE CACHE INTERNAL "Build rkaiq's Thumbnails Service"      FORCE)
        set(RKAIQ_HAVE_MULTIISP      FALSE CACHE INTERNAL "Build rkaiq's Dual ISP"                FORCE)
    endif()
...
elseif (RKAIQ_ISP_VERSION STREQUAL "30")
    ...
    set(RKAIQ_HAVE_AIE_V10   TRUE CACHE INTERNAL "Build rkaiq's AIE version 10"       FORCE)
    set(RKAIQ_HAVE_ASD_V10   FALSE CACHE INTERNAL "Build rkaiq's ASD version 10"       FORCE)
    # KA2: enable sensor degamma (SDG) — HW module exists on ISP3.0; stock leaves this off.
